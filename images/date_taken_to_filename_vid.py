#!/usr/bin/env python3
"""Rename video files based on MediaCreateDate.

Renamed from `rename_videos_by_media_date.py`.
"""
...
def main():
    parser = argparse.ArgumentParser(description="Rename videos based on MediaCreateDate")
